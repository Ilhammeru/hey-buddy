...
<div class="row valign-wrapper" style="padding: 0; margin-top: 0; margin-bottom: 2em">
    <div class="col s12 m6 offset-m3">
                        ...
                        <div class="collapsible-body collapseDeadlinedate" style="color: #40a1f8; border: none; padding-bottom: 0; margin-bottom: 0;">
                            <div class="row">
                                ...
                                <div class="col s3" style="padding: 0; margin: 0">
                                    <div class="selectMonth simple-calendar-btn btn-next">
                                        <p><?= date('F'); ?></p>
                                    </div>
        ...
        <div class="card" style="border-radius: 1.3em; box-shadow: none;">
            <div class="card-content" style="padding: 0.3em;">
                <form action="" id="uploadFileAdmin" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="helperImgRefer" class="helperImgRefer">
                </form>
...
<div class="row valign-wrapper" style="padding: 0; margin-top: 0; margin-bottom: 5em;">
    <div class="col s12 m6 offset-m3">
...
<script>
    $(document).ready(function() {
        ...
        sliderr.noUiSlider.on('slide', function() {
            var today = new Date();
            ...
            var deadlineDateInput = $('.deadlineDateField').val();

            var sliderValue = sliderr.noUiSlider.get();

            validationSlider(sliderValue, deadlineDateInput, 'slider', 'inputHour', 'inputMinutes', 'spanDeadlineHour');
            return false;
        })
    ...
    function fixCalendar() {
        var today = new Date();
        $('.calendar table tr td div').each(function() {
            var dates = $(this).data('date');
            var day = new Date(dates).getDate();
            if (new Date(dates).getTime() < today.getTime()) {
                $(this).removeClass('day');
                $(this).css('color', '##CBD1D2');
            }
        });
    }
            ...
            onOpenEnd: function() {
                ...
                $('.day').click(function(e) {
                    ...
                    setTimeout(function() {
                        ...
                        var check = checkDeadlineDate(data, 'inputMinutes', 'inputHour', 'deadlineDateField', 'slider', 'spanDeadlineHour');
                ...
                var check = getValidDate();

                var today = $('.today').attr('data-date').substring(0, 10);
                // var today = check.substring(0, 10);
    ...
    function collapseDeadlineHour() {
        $('.collapDeadlineHour').collapsible({
            onOpenStart: function() {
                ...
                $('.inputHour').val(newTime[0].hour);
                $('.inputMinutes').val(newTime[0].minutes);

                $('.spanDeadlineHour').text(newTime[0].hour + ':' + newTime[0].minutes);
                $('.spanDeadlineHour').css({
                    "color": "#5d5e5e",
                    "font-weight": "400"
                })
            ...
            onCloseEnd: function() {
                ...
                if (inputMinutes == '' && inputHour == '') {
                    ...
                    $('.arrowDeadlineHour1').html('');
                    $('.arrowDeadlineHour1').html(imgactive);
    ...
    function changeSlider(hour = '', minutes = '') {
        var sliderr = document.getElementById('slider');
        var hour = $('.inputHour').val();
        ...
        if (deadlineDate == '') {
            ...
            $('.inputHour').val(timeHelper[0].hour);
            $('.inputMinutes').val(timeHelper[0].minutes);

        } else {

            if (hour.length > 1) {

                validationTime('inputHour', 'inputMinutes', hour, minutes, 'slider', 'spanDeadlineHour', deadlineDate);
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.message == 'error') {
                    ...
                    //change value of helper
                    $('.helperImgRefer').val(1);
    ...
    function switchOrder(id) {
        ...
        if (dataCheck.length == 0) {
            slModal('Warning', 'Coadmin field cannot be null, at least you have one coadmin', 'warning', {
                buttons: false,
                timer: 1500
            });
        ...
        if (coadminArr[0] == '') {
            ...
            var trSuperAdmin = '<tr style="border:none;">' +
                '<td style="width: 0.8em;">' +
            ...
            var trCoadmin = '<tr style="border: none;">' +
                '<td style="width: 0.8em;">' +
    ...
    function changeDay(trigger) {
        ...
        if (trigger == 'today') {
            ...
            checkDeadlineDate('today', 'inputMinutes', 'inputHour', 'deadlineDateField', 'slider', 'spanDeadlineHour');
            ...
            //set span
            $('.spanDeadlineHour').text(timeHelper[0].hour + ':' + timeHelper[0].minutes)

        } else if (trigger == 'tomorrow') {

            checkDeadlineDate('tomorrow', 'inputMinutes', 'inputHour', 'deadlineDateField', 'slider', 'spanDeadlineHour');
            ...
            checkDeadlineDate('next week', 'inputMinutes', 'inputHour', 'deadlineDateField', 'slider', 'spanDeadlineHour');
    ...
    function saveSubjob(idForm) {
        ...
        if (deadlineDate == '' && hour != '') {

            slModal('failed', 'You cannot select deadline time without deadline date', 'warning', {
                buttons: false,
                timer: 1500
            })
